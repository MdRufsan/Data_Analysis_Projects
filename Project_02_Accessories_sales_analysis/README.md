...
<head>
    ...
    <script src="[https://cdn.jsdelivr.net/npm/chart.js@4.4.0/dist/chart.umd.min.js](https://cdn.jsdelivr.net/npm/chart.js@4.4.0/dist/chart.umd.min.js)"></script>
    <style>
        /* ─── Reset & Base ─── */
        * {
            margin: 0;
...
<body>
    ...
    <script>
        ...
        totalQtyRow.innerHTML = `<td><strong>Total</strong></td><td style="text-align:right;"><strong>\${qtySum}</strong></td>`;
        ...
        totalRegionRow.innerHTML = `<td><strong>Grand Total</strong></td><td style="text-align:right;"><strong>$\${regionSum.toLocaleString()}</strong></td>`;
